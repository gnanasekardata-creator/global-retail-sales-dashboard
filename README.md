...
## ⚠️ Note
The DiscountNew column in the dataset was derived from Power BI calculations and then exported to ensure consistency between the dataset and dashboard.
